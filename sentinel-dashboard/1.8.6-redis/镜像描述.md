...
> Docker run --name sentinel-dashboard  -e REDIS_HOST=127.0.0.1 -e REDIS_PORT=6379 -p 8080:8080 osmiling/sentinel-dashboard:1.8.6-redis
...
services:
  sentinel-dashboard:
    image: osmiling/sentinel-dashboard:1.8.6-redis
