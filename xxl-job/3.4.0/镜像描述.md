...
该镜像使用外部 mysql 数据库，需要先创建一个库表，可以参考文档创建，或查看 [xxl-job.sql(注意选择版本)](https://github.com/xuxueli/xxl-job/blob/3.4.0-release/doc/db/tables_xxl_job.sql)。
